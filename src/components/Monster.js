...
import { deleteMonster } from '../store/actions';
        ...
        return (
            <div className="monster-wrapper">
                ...
                <div className="delete-monster">
                    <img alt="Delete" src="icons/trash-can.svg" id={this.props.monsterId} onClick={(e) => this.deleteMonster(e)} />
                </div>
            </div>
        )
    }
